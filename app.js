...
root.addEventListener('click',event=>{
  ...
  if(target.hasAttribute('data-quiz-answer')){dispatch({type:'SET_QUIZ_ANSWER',topic:target.dataset.quizTopic,question:Number(target.dataset.quizQuestion),answer:Number(target.dataset.quizValue)});return}
